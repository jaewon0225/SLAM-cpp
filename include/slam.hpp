...
public:
  ...
  Eigen::Matrix3d
  toTransformationMatrix() const; // pose -> homogeneous transformation matrix
};

static Pose fromTransformationMatrix(
    const Eigen::Matrix3d &matrix); // homogeneous transformation matrix -> pose
...
public:
  ...
  Edge(int from, int to, const Pose &measurement,
